...
from runtests.mylang_raw import Transformer, Lark_StandAlone
class mylang_Transformer(Transformer):
    ...
    def name_0(self, __args):
        return  __get_value(__args[1-1])
    def func_0(self, __args):
        return   SFunc(__args[2-1], __args[4-1], __args[6-1]) | __get_location(__args[1-1])
    def block_0(self, __args):
        return   __args[1-1]
    def binder_0(self, __args):
        return  __args[1-1]
    def stmt_0(self, __args):
        return  SDecl(__args[2-1]) | __get_location(__args[1-1])
    def stmt_1(self, __args):
        return  SAssign(__get_value(__args[1-1]), __args[3-1]) | __get_location(__args[1-1])
    def stmt_2(self, __args):
        return  SExpr(__args[1-1])
    def stmt_3(self, __args):
        return  SLoop(__args[2-1]) | __get_location(__args[1-1])
    def stmt_4(self, __args):
        return  SFor(__args[2-1], __args[4-1], __args[6-1]) | __get_location(__args[1-1])
    def stmt_5(self, __args):
        return  SIf(__args[2-1], __args[4-1], None) | __get_location(__args[1-1])
    def stmt_6(self, __args):
        return  SIf(__args[2-1], __args[4-1], __args[6-1]) | __get_location(__args[1-1])
    def stmt_7(self, __args):
        return  SBreak()
    def stmt_8(self, __args):
        return  SContinue()
    def or_expr_0(self, __args):
        return  EOr(__args[1-1], __args[2-1]) | __get_location(__args[1-1])
    def or_expr_1(self, __args):
        return  __args[1-1]
    def and_expr_0(self, __args):
        return  EAnd(__args[1-1], __args[2-1]) | __get_location(__args[1-1])
    def and_expr_1(self, __args):
        return  __args[1-1]
    def binop_0(self, __args):
        return  (__get_location(__args[1-1]), __get_value(__args[1-1]))
    def binop_1(self, __args):
        return  (__get_location(__args[1-1]), __get_value(__args[1-1]) + "_" + __get_value(__args[2-1]))
    def bin_0(self, __args):
        return  resolve_binop(__args)
    def not_0(self, __args):
        return  ENot(__args[2-1]) | __get_location(__args[1-1])
    ...
    def lhs_0(self, __args):
        return  LVar(__get_value(__args[1-1])) | __get_location(__args[1-1])
    def lhs_1(self, __args):
        return  LIt(__args[1-1], __args[4-1]) | __get_location(__args[2-1])
    def lhs_2(self, __args):
        return  IAttr(__args[1-1], __args[3-1]) | __get_location(__args[2-1])
    def pair_0(self, __args):
        return  (__args[1-1], __args[3-1])
    def atom_0(self, __args):
        return  EIt(__args[1-1], __args[4-1]) | __get_location(__args[1-1])
    def atom_1(self, __args):
        return  EAttr(__args[1-1], __args[3-1]) | __get_location(__args[2-1])
    def atom_2(self, __args):
        return  EApp(__args[1-1], __args[3-1]) | __get_location(__args[2-1])
    def atom_3(self, __args):
        return  EList(__args[2-1]) | __get_location(__args[1-1])
    def atom_4(self, __args):
        return  EPar(__args[2-1], __args[3-1]) | __get_location(__args[1-1])
    def atom_5(self, __args):
        return  EDict(__args[2-1], __args[3-1]) | __get_location(__args[1-1])
    def atom_6(self, __args):
        return  EVal(eval(__get_value(__args[1-1]))) | __get_location(__args[1-1])
    def atom_7(self, __args):
        return  EVal(eval(__get_value(__args[1-1]))) | __get_location(__args[1-1])
    def atom_8(self, __args):
        return  EVal(None) | __get_location(__args[1-1])
    def atom_9(self, __args):
        return  EVal(True) | __get_location(__args[1-1])
    def atom_10(self, __args):
        return  EVal(False) | __get_location(__args[1-1])
    def atom_11(self, __args):
        return  EVar(__get_value(__args[1-1]))    | __get_location(__args[1-1])
    def atom_12(self, __args):
        return  ENeg(__args[2-1])    | __get_location(__args[1-1])
    def atom_13(self, __args):
        return  EInv(__args[2-1])    | __get_location(__args[1-1])
