...
public partial class DList
{
  ...
  public Cls()
  {
    ...
    Dict = new System.Collections.Generic.Dictionary<InternString, DObj>
    {
      ...
      { "append".ToIStr(), MK.CreateFunc(bind_append) },
      { "extend".ToIStr(), MK.CreateFunc(bind_extend) },
      { "insert".ToIStr(), MK.CreateFunc(bind_insert) },
      { "remove".ToIStr(), MK.CreateFunc(bind_remove) },
      { "find".ToIStr(), MK.CreateFunc(bind_find) },
      { "index".ToIStr(), MK.CreateFunc(bind_index) },
      { "__delitem__".ToIStr(), MK.CreateFunc(bind___delitem__) },
      { "sort".ToIStr(), MK.CreateFunc(bind_sort) },
      { "array".ToIStr(), MK.CreateFunc(bind_array) },
      { "__len__".ToIStr(), MK.CreateFunc(bind___len__) },
      { "clear".ToIStr(), MK.CreateFunc(bind_clear) },
      { "__setitem__".ToIStr(), MK.CreateFunc(bind___setitem__) },
      { "__getitem__".ToIStr(), MK.CreateFunc(bind___getitem__) },
    };
  }
  }
}
